...
import com.netease.nim.live.manager.OnlineStateEventManager;
        ...
        AVChatManager.getInstance().observeIncomingCall(new Observer<AVChatData>() {
            ...
            public void onEvent(AVChatData data) {
              ...
              /*暂时不用*/
                ...
                AVChatProfile.getInstance().launchActivity(data, com.netease.nim.live.others.MainActivity.FROM_BROADCASTRECEIVER);
            }
        }, register);
    }
