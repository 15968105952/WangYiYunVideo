...
import com.netease.nim.live.MainActivity;
...
//            showNotification("上传已完成", true);
    ...
    private UploadBuilder getUploadBuild(String name) {
        UploadBuilder builder = new UploadBuilder(DemoCache.getContext(), "55f3fcee14db4682a11e1c633739d314", "test_accid_0505", "b99d5baf7afd461e8b1ca747f112bee80854adf2")
